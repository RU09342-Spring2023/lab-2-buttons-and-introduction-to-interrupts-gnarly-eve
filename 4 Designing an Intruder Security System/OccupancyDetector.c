 ...
 *      Author: eve
 *
 *      when it boots up and starts, its in an armed state. it will blink to show its working
 *
 *      then trigger state - blink for 10 sec to give warning that intruder needs to leave.
 *
 *      every time someone triggers the trigger state, they get 10 sec warning of the RED LED blinking
 *
 *      if intruder doesn't leave, RED LED stays on, doesn't blink.
 *
 */
